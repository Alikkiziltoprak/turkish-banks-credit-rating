...
│
├── notebooks/
│   ├── 01_financial_analysis.ipynb     # Phase 1: Core financial metrics
│   ├── 02_sovereign_linkage.ipynb      # Phase 2: Macro risk integration
│   ├── 03_risk_scoring.ipynb           # Phase 2: XGBoost + SHAP scoring
│   └── 04_nlp_sentiment.ipynb         # Phase 3: NLP layer (optional)
│
├── src/
│   ├── data_loader.py          # Data ingestion from APIs
│   ├── financial_metrics.py    # Ratio calculations
│   ├── risk_scorer.py          # ML risk scoring engine
│   ├── sovereign_linkage.py    # Macro variable integration
│   └── report_generator.py    # Analyst memo generation
│
├── reports/
│   └── analyst_memos/          # Rating Committee simulation outputs
│       ├── GARAN_memo.md
│       ├── AKBNK_memo.md
│       └── ...
│
