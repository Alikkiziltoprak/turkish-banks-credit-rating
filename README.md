...
<img src="reports/dashboard_screenshot.png" width="900"/>

<img src="reports/composite_scores.png" width="900"/>

<img src="reports/radar_chart.png" width="900"/>
...
| Is Bankasi | ISCTR | Private |
| Yapi Kredi | YKBNK | Private |
| Halkbank | HALKB | State |
| Vakifbank | VAKBN | State |
...
│   │   ├── GARAN_memo.md
│   │   └── AKBNK_memo.md
│   └── Turkish_Banks_Annual_Credit_Review_2025.md
├── streamlit_app/
│   └── app.py
├── requirements.txt
└── README.md
...
| Source | Data | Access |
|--------|------|--------|
| BDDK | Bank financials (quarterly) | Free / Public |
| TCMB EVDS | Macro data, FX, rates | Free API |
| yfinance | Stock prices, market data | Free Python library |
| World Bank API | GDP, inflation, sovereign indicators | Free API |
| KAP | Annual reports, earnings releases | Free / Public |
...
This project was developed by **Ali Kiziltoprak**, holder of:
- SPK (CMB Turkey) Duzey 3 License
- SPK Corporate Governance and Credit Rating License
